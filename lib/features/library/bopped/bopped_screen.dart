  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('Bopped Music', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
              ...
              : Padding(
                  ...
                  child: GridView.builder(
                    ...
                    gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                      ...
                      crossAxisSpacing: 16,
                      mainAxisSpacing: 16,
                      childAspectRatio: 0.75, // Makes the cards slightly taller than they are wide
                    ),
